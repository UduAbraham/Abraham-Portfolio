...
export default function ProjectsPage() {
  return (
    <div className="min-h-screen py-20 bg-[#0f1c23] dark:bg-white font-display text-white" id="Project">
      <div className="container mx-auto px-6 sm:px-10 lg:px-20">

        <section className="mb-12">
          <h2 className="text-4xl sm:text-5xl font-black text-blue-500">Projects</h2>
